...
export default function Contact() {
  ...
  const contactInfo = [
    ...
    { icon: Mail, title: 'Email Us', details: [<a href="https://mail.google.com/mail/?view=cm&fs=1&to=gyaneshwarudasi@gmail.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-black">gyaneshwarudasi@gmail.com</a>] },
