...
const MANDATORY_PRODUCTS = [
  ...
  { id: 2, name: 'Ivory Threadwork Georgette Groom Sherwani', category: 'Sherwani', price: 48000, image: sherwani4 },
  // Suit (3-4)
  { id: 3, name: 'Italian Viscose Velvet Zari Bandhgala Suit', category: 'Suit', price: 28500, image: suit1 },
  { id: 4, name: 'Classic Black Tuxedo Suit with Satin Lapel', category: 'Suit', price: 22000, image: suit3 },
  // Kurta (5-10)
  { id: 5, name: 'Handwoven Benarasi Silk Kurta Pajama Set', category: 'Kurta', price: 18000, image: kurta1 },
  { id: 6, name: 'Lucknowi Chikankari Festive Kurta', category: 'Kurta', price: 12500, image: kurta3 },
  { id: 7, name: 'Classic White Kurta Set', category: 'Kurta', price: 8500, image: kurta11 },
  { id: 8, name: 'Wine Red Silk Kurta', category: 'Kurta', price: 12000, image: kurta12 },
  { id: 9, name: 'Royal Silk Kurta Pajama', category: 'Kurta', price: 15000, image: kurta4 },
  { id: 10, name: 'Cotton Summer Kurta', category: 'Kurta', price: 5500, image: kurta5 },
  // Blazer (11-16)
  { id: 11, name: 'Charcoal Grey Premium Linen Blazer', category: 'Blazer', price: 15000, image: blazer1 },
  { id: 12, name: 'Classic Navy Blazer', category: 'Blazer', price: 18000, image: blazer2 },
  { id: 13, name: 'Black Tuxedo Blazer', category: 'Blazer', price: 22000, image: blazer3 },
  { id: 14, name: 'Grey Wool Blazer', category: 'Blazer', price: 16000, image: blazer4 },
  { id: 15, name: 'Tan Leather Blazer', category: 'Blazer', price: 25000, image: blazer6 },
  { id: 16, name: 'Modern Fit Blazer', category: 'Blazer', price: 14000, image: blazer7 },
  // Pathani (17)
  { id: 17, name: 'Emerald Green Silk Pathani Suit', category: 'Pathani', price: 14500, image: pathani1 },
  // Indo-Western (18)
  { id: 18, name: 'Classic Navy Blue Indo-Western Set', category: 'Indo-Western', price: 28000, image: indowestern1 },
  // Shirt (19)
  { id: 19, name: 'Premium Cotton Formal Shirt', category: 'Shirt', price: 4500, image: shirt1 },
  // Jacket (20)
  { id: 20, name: 'Leather Biker Jacket', category: 'Jacket', price: 18000, image: jacket1 },
  // Payjama (21-25)
  { id: 21, name: 'Silk Blend Payjama Set', category: 'Payjama', price: 8500, image: payjama1 },
  { id: 22, name: 'Premium Cotton Pajama', category: 'Payjama', price: 5500, image: payjama2 },
  { id: 23, name: 'Linen Casual Payjama', category: 'Payjama', price: 4800, image: payjama3 },
  { id: 24, name: 'Silk Designer Pajama', category: 'Payjama', price: 6500, image: payjama4 },
  { id: 25, name: 'Classic White Payjama', category: 'Payjama', price: 4200, image: payjama5 },
  // Formal Paint (26-30)
  { id: 26, name: 'Classic Black Formal Paint', category: 'Formal Paint', price: 4500, image: formalpaint1 },
  { id: 27, name: 'Navy Blue Formal Trouser', category: 'Formal Paint', price: 4800, image: formalpaint2 },
  { id: 28, name: 'Grey Wool Formal Paint', category: 'Formal Paint', price: 5500, image: formalpaint3 },
  { id: 29, name: 'Beige Linen Formal Paint', category: 'Formal Paint', price: 4200, image: formalpaint4 },
  { id: 30, name: 'Tailored Black Trouser', category: 'Formal Paint', price: 5000, image: formalpaint5 },
  // Safari (31)
  { id: 31, name: 'Safari Summer Suit', category: 'Safari', price: 15000, image: safari1 },
  // Uniform (32)
  { id: 32, name: 'School Uniform Blazer', category: 'Uniform', price: 6500, image: uniform1 },
  // Jeans (33-37)
  { id: 33, name: 'Slim Fit Designer Jeans', category: 'Jeans', price: 5500, image: jeans1 },
  { id: 34, name: 'Vintage Wash Straight Fit Jeans', category: 'Jeans', price: 6200, image: jeans2 },
  { id: 35, name: 'Premium Denim Casual Jeans', category: 'Jeans', price: 4800, image: jeans3 },
  { id: 36, name: 'Classic Blue Slim Jeans', category: 'Jeans', price: 5500, image: jeans4 },
  { id: 37, name: 'Black Stretch Skinny Jeans', category: 'Jeans', price: 4500, image: jeans5 },
  // Accessories (38)
  { id: 38, name: 'Designer Waistcoat', category: 'Accessories', price: 3500, image: accessories1 },
  // Additional Kurta (39-44)
  { id: 39, name: 'Embroidered Festival Kurta', category: 'Kurta', price: 9800, image: kurta6 },
  { id: 40, name: 'Bespoke Wedding Kurta', category: 'Kurta', price: 18000, image: kurta7 },
  { id: 41, name: 'Traditional Kurta Set', category: 'Kurta', price: 7500, image: kurta8 },
  { id: 42, name: 'Modern Designer Kurta', category: 'Kurta', price: 11000, image: kurta9 },
  { id: 43, name: 'Premium Wedding Kurta', category: 'Kurta', price: 22000, image: kurta10 },
  { id: 44, name: 'Handloom Cotton Kurta', category: 'Kurta', price: 4500, image: kurta2 },
  // Additional Blazer (45-50)
  { id: 45, name: 'Slim Fit Formal Blazer', category: 'Blazer', price: 17000, image: blazer8 },
  { id: 46, name: 'Wedding Guest Blazer', category: 'Blazer', price: 19500, image: blazer9 },
  { id: 47, name: 'Bespoke Designer Blazer', category: 'Blazer', price: 28000, image: blazer10 },
  { id: 48, name: 'Premium Italian Blazer', category: 'Blazer', price: 32000, image: blazer11 },
  { id: 49, name: 'Velvet Evening Blazer', category: 'Blazer', price: 24000, image: blazer12 },
  { id: 50, name: 'Linen Summer Blazer', category: 'Blazer', price: 11000, image: blazer13 },
];
